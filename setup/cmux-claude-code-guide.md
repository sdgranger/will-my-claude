...
## 3. cmux 스킬 (Claude Code가 cmux를 자동 활용)

스킬 파일을 `~/.claude/skills/cmux/`에 복사하면 Claude Code가 cmux 환경을 **자동으로 감지**하고 활용합니다.

```bash
# 스킬 설치 (will-my-claude 레포에서)
